...
consumer_key="k5jUN9hVqs0Y2LoNRGg0pyvLv"
consumer_secret="jYoIJLFIVpTpNOyo5XEH7xFgZn9gZQxXezLTEzHNHOEhmVuKTA"
access_token="1065794281250660354-yQD5vGFA8ZbN5xEGfByUUMVt9FEiCC"
access_token_secret="5zxJzEv2eqv7P3c59JFSTUpnzarIwPFKsw1T28uNUSdX8"
...
# setup search terms (polictal : cpc, lpc Company: apple, microdoft Brands: xboxone, playstation Stock: tsx, nyse RideSharingapps: uber, lyft)
track = ['#cpc','#lpc',"#ndp", "#pcpo", "#ondp","#democrats", "#republican","#bccp", " #olp", "#pq",
         ...
         '#nytimes','#wsj','#latimes','#usatoday','#denverpost','#thestar',"#newsday","#theglobeandmail","#nationalpost",'#torontosun','#sad','#mood',"#depressed","#cry"]
language = ['en']
